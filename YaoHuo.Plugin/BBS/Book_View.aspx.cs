                                ...
                                while (true)
                                {
                                    ...
                                    switch (num)
                                    {
                                        ...
                                        case 130:
                                            ...
                                            continue;
                                        case 434:
                                            bookVo.book_content = text7 + model.peroid + "期投注[" + Tool.GetMarkSix_PlayName(model.types.ToString()) + "]为" + model.types_content + " 共" + model.num + "注" + text9 + "<br/>----------<br/>" + bookVo.book_content;
                                            num = 305;
                                            continue;
                                        case 241:
                                        case 305:
