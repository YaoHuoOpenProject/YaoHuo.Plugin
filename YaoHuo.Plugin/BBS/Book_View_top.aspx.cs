        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (tops == "1")
                {
                    ...
                    {
                        string text = "{" + userVo.nickname + "(ID" + userVo.userid + ")置顶此贴" + $"{DateTime.Now:MM-dd HH:mm}" + "}<br/>";
                        text += bookVo.whylock;
                ...
                {
                    string text = "{" + userVo.nickname + "(ID" + userVo.userid + ")取消置顶此贴" + $"{DateTime.Now:MM-dd HH:mm}" + "}<br/>";
                    text += bookVo.whylock;
