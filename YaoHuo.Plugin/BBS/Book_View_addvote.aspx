...
Response.Write(WapTool.showTop(this.GetLang("发表投票帖|發表主題|add subject"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p>");
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("悬赏妖晶<input type=\"number\" oninput=\"if(value.length>8)value=value.slice(0,8)\" max=\"10000000\" format=\"*N\" name=\"sendmoney\" value=\"" + sendmoney + "\"  style=\"margin:0 10px 0 6px;width:80px;max-width:50%\"/><br/>");
        //显示投票值
    ...
    strhtml.Append("</div><script type=\"text/javascript\" src=\"/netcss/js/SaveDraft.js?Z9588\"></script>");
