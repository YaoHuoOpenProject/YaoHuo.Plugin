...
if (ver == "1")
{
    ...
    if (this.INFO == "")
    {
        ...
        strhtml.Append("<anchor><go href=\""+http_start+"bbs/book_view_lock.aspx\" method=\"post\" accept-charset=\"utf-8\">");
        ...
        strhtml.Append("<postfield name=\"tops\" value=\"1\"/>");
        ...
        strhtml.Append("<b>" + this.GetLang(lang1 + "锁定失败！|" + lang2 + "锁定失敗！|" + lang3 + " Lock Failure!") + "</b><br/>");
    }
    else if (this.INFO == "OK")
    {
        strhtml.Append("<b>" + this.GetLang(lang1 + "锁定成功！|" + lang2 + "锁定成功！|" + lang3 + " Lock successfully!") + "</b><br/>");
    }
